      ...
      builder: (context) {
        return StatefulBuilder(
          builder: (context, setDialogState) {
            ...
            final int correctAnswer = quiz['answer'] ?? 0;
                      ...
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            ...
                            color: selectedOption == correctAnswer ? Colors.green.shade900 : Colors.red.shade900,
                          ),
                        ),
                      ),
                    ],
                              ...
                              child: DropdownButton<int>(
                                ...
                                items: _subjects.map<DropdownMenuItem<int>>((sub) {
                                  return DropdownMenuItem<int>(
                                    value: sub['id'] as int,
                                    child: Text('${sub['title']} (${sub['instructor']})'),
                                  );
                                }).toList(),
                                onChanged: (val) {
                                  if (val != null) {
                    ...
                    ? const Center(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: 12),
                            Text('해당 과목에 저장된 AI 요약 노트가 없습니다.', style: TextStyle(color: Colors.grey, fontSize: 16)),
                          ],
                        ),
                      )
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final List<dynamic> keywords = note['keywords'] ?? ['AI 분석'];
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        note['created_at']?.toString().substring(0, 10) ?? '저장됨',
                                        style: const TextStyle(color: Colors.grey, fontSize: 13),
                                      ),
                                    ],
                                  ),
                                  const Divider(height: 24),
                                  const Text('📝 핵심 요약', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.indigo)),
                                  ...
                                  const SizedBox(height: 12),
                                  const Text('🏷️ 주요 키워드', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.indigo)),
                                  const SizedBox(height: 6),
                                  Wrap(
                                    spacing: 6,
                                    children: keywords.map((kw) {
                                      return Chip(
                                        label: Text(kw.toString(), style: const TextStyle(fontSize: 12)),
